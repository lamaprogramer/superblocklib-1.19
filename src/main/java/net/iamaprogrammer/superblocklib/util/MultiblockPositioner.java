...
public class MultiblockPositioner {
    ...
    private final boolean centerBlockX;
    private final boolean centerBlockY;
    private final boolean centerBlockZ;

    private final boolean centerModelX;
    private final boolean centerModelY;
    private final boolean centerModelZ;
